<?php  
    echo Open('div', array('align' => 'center', 'class' => 'col-md-12'));
        echo '<h1 class="page-header"><small><font class="text-success">BUSCAR E IMPRIMIR SOLICITUDES DE FISIATRIA PENDIENTES</font></small></h1>';
    echo Close('div');
    echo lineBreak(1);
    echo Open('form', array('action' => base_url('fisiatria/fisiatria/list_solicitudes'), 'method' => 'post'));
            ...
            $tiposerv_combo = combobox($listtiposerv, array('label' => 'tipo', 'value' => 'id'), array('name' => 'servicio_consultado', 'id' => 'servicio_consultado', 'class' => 'combobox form-control input-sm'), true);
            echo Open('div', array('class' => 'col-md-4 form-group'));
                echo Open('div', array('class' => 'input-group has-success'));
                    echo tagcontent('span', '<span class="glyphicon glyphicon-random"></span> Servicio Consultado:', array('class' => 'input-group-addon'));
                    echo $tiposerv_combo; 
                echo Close('div');
            echo Close('div');
        ...
        echo Open('div', array('class' => 'col-md-4 form-group'));
                echo Open('div', array('class' => 'input-group has-success'));
                    ...
                    echo input(array( 'id'=>'ci','name'=>'ci','class'=>'form-control input-sm typeahead','placeholder'=>'Num. identificacion',
                     'callback'=>'refresh_cart_load_client','data-url'=>  base_url('common/autosuggest/get_client_by_name_hmc/%QUERY'), 'style'=>'position: absolute;'));
